...
{/*
<span className="h text">
        <span className="ht1">WE</span><br/><span className="ht2">HELP</span><br/><span className="ht3">YOU BUILD</span><br/>
      </span> 

      <div class="content">
  <div class="content__container"> 
    <ul class="content__container__list">
      <li class="content__container__list__item">PRODUCT</li>
      <li class="content__container__list__item">SOLUTIONS</li>
      <li class="content__container__list__item">TECHNOLOGIES</li>
    </ul>
  </div>
</div>*/}
      ...
      <div class="wrapper">
  <a class="cta" href="#" onClick={x} >
    <span1>BUILD A PROJECT</span1>
    <span1>
